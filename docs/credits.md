...
| [Yamato Security – WELA](https://github.com/Yamato-Security/WELA) | A second source for settings (the values its `configure` command uses, such as NTLM and AD CS auditing), and the structure of this site's stylesheet. | MIT |
