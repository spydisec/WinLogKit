...
| Microsoft-Windows-Bits-Client/Operational | Channel | - | 1 MB -> 128 MB | Low | Y | :material-check: | :material-check: | :material-check: |
| Microsoft-Windows-Windows Firewall With Advanced Security/Firewall | Channel | - | 1 MB -> 128 MB | Low | Y | :material-check: | :material-check: | :material-check: |
| Microsoft-Windows-NTLM/Operational | Channel | - | 1 MB -> 128 MB | Low | Y | :material-check: | :material-check: | :material-check: |
| Microsoft-Windows-Security-Mitigations/KernelMode | Channel | - | 1 MB -> 128 MB | Low | Y | :material-check: | :material-check: | :material-check: |
| Microsoft-Windows-Security-Mitigations/UserMode | Channel | - | 1 MB -> 128 MB | Low | Y | :material-check: | :material-check: | :material-check: |
| Microsoft-Windows-PrintService/Admin | Channel | - | 1 MB -> 128 MB | Low | Y | :material-check: | :material-check: | :material-check: |
| Microsoft-Windows-PrintService/Operational | Channel | - | 1 MB -> 128 MB | Low | Y | :material-check: | :material-check: | :material-check: |
| Microsoft-Windows-SmbClient/Security | Channel | - | 8 MB -> 128 MB | Low | Y | :material-check: | :material-check: | :material-check: |
| Microsoft-Windows-AppLocker/EXE and DLL | Channel | - | 1 MB -> 128 MB | Low | Y | :material-check: | :material-check: | :material-check: |
| Microsoft-Windows-AppLocker/MSI and Script | Channel | - | 1 MB -> 128 MB | Low | Y | :material-check: | :material-check: | :material-check: |
| Microsoft-Windows-AppLocker/Packaged app-Deployment | Channel | - | 1 MB -> 128 MB | Low | Y | :material-check: | :material-check: | :material-check: |
| Microsoft-Windows-AppLocker/Packaged app-Execution | Channel | - | 1 MB -> 128 MB | Low | Y | :material-check: | :material-check: | :material-check: |
| Microsoft-Windows-CodeIntegrity/Operational | Channel | - | 1 MB -> 128 MB | Low | Y | :material-check: | :material-check: | :material-check: |
| Microsoft-Windows-Diagnosis-Scripted/Operational | Channel | - | 1 MB -> 128 MB | Low | Y | :material-check: | :material-check: | :material-check: |
...
| Computer Account Management (DC) | Audit subcategory | 4741-4743, 4742 | - | Low | A C S Y | - | - | :material-check: |
| Distribution Group Management (DC) | Audit subcategory | - | - | Low | Y | - | - | :material-check: |
| Other Account Management Events | Audit subcategory | 4782, 4793 | - | Low | A C S Y | :material-check: | :material-check: | :material-check: |
| Security Group Management | Audit subcategory | 4728, 4729, 4732, 4733, 4756, 4757, 4799, 4727-4764 | - | Low | A C S Y | :material-check: | :material-check: | :material-check: |
| User Account Management | Audit subcategory | 4720, 4723, 4724, 4726, 4738, 4740, 4798, 4720-4767 | - | Low | A C S Y | :material-check: | :material-check: | :material-check: |
| Plug and Play | Audit subcategory | 6416, 6419-6424 | - | Low | Y | :material-check: | :material-check: | :material-check: |
| Process Creation | Audit subcategory | 4688 | - | High | A C S Y | :material-check: | :material-check: | :material-check: |
| RPC Events | Audit subcategory | 5712 | - | Watch | Y | :material-check: | :material-check: | :material-check: |
| Directory Service Access (DC) | Audit subcategory | 4662, 4661 | - | Low | S Y | - | - | :material-check: |
| Directory Service Changes (DC) | Audit subcategory | 5136, 5136-5141 | - | Low | S Y | - | - | :material-check: |
...
| Other Object Access Events | Audit subcategory | 4698, 4702, 4698-4702 | - | Low | A Y | :material-check: | :material-check: | :material-check: |
| Removable Storage | Audit subcategory | 4663 | - | Watch | Y | :material-check: | :material-check: | :material-check: |
| SAM | Audit subcategory | 4661 | - | Watch | Y | :material-check: | :material-check: | :material-check: |
| Audit Policy Change | Audit subcategory | 4719, 4715, 4907 | - | Low | A C S Y | :material-check: | :material-check: | :material-check: |
...
| Other System Events | Audit subcategory | - | - | Low | Y | :material-check: | :material-check: | :material-check: |
| `Microsoft\Windows\CurrentVersion\Policies\System\Audit\ProcessCreationIncludeCmdLine_Enabled` | Registry | 4688 | - | High | A C S Y | :material-check: | :material-check: | :material-check: |
| `Policies\Microsoft\Windows\PowerShell\ScriptBlockLogging\EnableScriptBlockLogging` | Registry | 4104 | - | High | A Y | :material-check: | :material-check: | :material-check: |
| `Wow6432Node\Policies\Microsoft\Windows\PowerShell\ScriptBlockLogging\EnableScriptBlockLogging` | Registry | - | - | High | A Y | :material-check: | :material-check: | :material-check: |
