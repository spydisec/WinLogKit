...
| `Policies\Microsoft\Windows\PowerShell\Transcription\OutputDirectory` | Registry | - | - | Watch | - | - | - |
| `Wow6432Node\Policies\Microsoft\Windows\PowerShell\Transcription\OutputDirectory` | Registry | - | - | Low | - | - | - |
